                ...
                <div class="flex flex-row justify-between items-center px-5 mt-5 mb-4 my-4">
                    ...
                    <div class="text-gray-200">
                        <div class="font-bold text-xl">Bridget's Station</div>
                            <span class="text-xs">Location: {{Auth::user()->branch->branch_name}}</span>
                        </div>
                        <div class="flex items-center text-gray-200">
                            <div>
                                <button data-modal-target="popup-modal" data-modal-toggle="popup-modal" class="px-4 py-2 bg-gray-800 hover:bg-red-500 text-gray-200 font-semibold rounded">
                                Logout
                                </button>
                            </div>
                        </div>
